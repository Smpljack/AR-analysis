...
freq="daily"
base_path="/archive/Ming.Zhao/awg/2022.03/c192L33_am4p0_amip_HIRESMIP_nudge_wind_1951_2020/gfdl.ncrc4-intel-prod-openmp/pp/"
...
for var in ${land_cmip_vars[@]} ; do
    dmget ${land_cmip_path}land_cmip.{1951..1990}0101-*1231.${var}.nc &
done

for var in ${land_vars[@]} ; do
    dmget ${land_path}land.{1951..1990}0101-*1231.${var}.nc &
done

for var in ${atmos_cmip_vars[@]} ; do
    dmget ${atmos_cmip_path}atmos_cmip.{1951..1990}0101-*1231.${var}.nc &
done

for var in ${atmos_cmip_6hr_vars[@]} ; do
    dmget ${atmos_cmip_6hr_path}atmos_cmip.{1951..1990}010100-*123123.${var}.nc &
done

for var in ${river_vars[@]} ; do
    dmget ${river_path}river.{1951..1990}0101-*1231.${var}.nc &
done
